...
# Added functionality: Stop/Resume functionality is being fixed.
    ...
    if is_initial_stopped == True:
        ...
        for docx in goals_ref:
            ...
            if query:
                for doc in query:
                    new_id = doc.id
                    currentlyProcessedOrder_col.document(new_id).update({"orderStatus": "OnItsWay"})
            ...
            if query:
                for doc in query:
                    ...
                    go_to_goal(float(data.get("position_x")), float(data.get("position_y")), float(data.get("rotation_z")))
                    print("!!!!!")
                    break
            else:
                print("error")       
