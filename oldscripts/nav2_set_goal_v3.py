...
# Added functionality: Start Automation command functionality is added.
...
def handle_commands():
    global robotCommands_ref, robotCommands_col, goals_ref, goals_col
    
    col_query2 = None  # Initializing col_query2 at the start of the function
