...
# Added functionality: Buggy behaviour of Stop Automation is fixed and completed.

    
def handle_commands():
    global robotCommands_ref, robotCommands_col, goals_ref, goals_col, nav, col_query2, is_initial_stopped, command
