...
# Added functionality: Buggy behaviour of Stop Current Goal and Resume Current Goal is fixed and completed.
...
# cancel current operation -> cancel current task(2) ve simdiki goal'ı sil(3), table0'a git(4),  goals collection'ınını dinlemeyi bırak(1)    Goal cancel oldugunda ilgili orderID'nin durumunu "Cancelled" yap. Ve o entryi sil currprocessingOrders'dan(5) cancelCurrentGoal
